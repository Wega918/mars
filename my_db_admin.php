...
$databases_config = array(
    ...
    array(
        ...
        'host' => 'localhost',
        'user' => 'aster91_marsgame2_',
        'pass' => 'jeJeQLj8QkkF1',
        'dbname' => 'aster91_marsgame2_'
    ),
    array(
...
if (isset($_POST['bulk_table_action'])) {
    ...
    $selected_tables = isset($_POST['selected_tables']) ? $_POST['selected_tables'] : array();
...
if (isset($_GET['export_selected'])) {
    $selected_tables = isset($_GET['tables']) ? explode(',', $_GET['tables']) : array();
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (sidebarResizer) {
                ...
                var lastX = 0;
                var sidebarWidth = <?= isset($_COOKIE['sidebarWidth']) ? (int)$_COOKIE['sidebarWidth'] : 250 ?>;
