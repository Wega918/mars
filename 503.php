...
echo '<center>Ошибка 503: Временные сложности с обработкой дынных на сервере.</center>';
...
echo '<div class = "trnt-block"><div class = "wrap1"><div class = "wrap2"><div class = "wrap3"><div class = "wrap4"><div class = "wrap5"><div class = "wrap6"><div class = "wrap7"><div class = "wrap8"><div class = "wrap-content">';
echo 'К сожалению, сайт пользуется чрезмерным спросом, и сервер не в состоянии обработать все запросы.<br><br>
