...
$enot = mysql_fetch_assoc(mysql_query("SELECT * FROM `chat` WHERE `id` = '".$id."'"));
...
header('Location: '.$HOME.'chat/otvet.php?id='.$enot['id'].'');
...
mysql_query("INSERT INTO `chat` SET `msg` = '".$msg1."', `avtor` = '".$user['id']."', `time` = '".time()."', `id_komu` = '".$ank['id']."'");
...
echo '<a class="btnl" style="margin-top:2px;" href="'.$HOME.'chat/"><img src="/images/header/arrow_left_white2.png" width="12" height="12"> Чат</a>';
