...
header('Location: '.$HOME.'ass/otvet.php?id='.$enot['id'].'');
...
mysql_query("INSERT INTO `ass` SET `msg` = '".$msg1."', `avtor` = '".$user['id']."', `time` = '".time()."', `id_komu` = '".$ank['id']."'");
...
echo '<a class="btnl" style="margin-top:2px;" href="'.$HOME.'ass/"><img src="/images/header/arrow_left_white2.png" width="12" height="12"> Чат</a>';
