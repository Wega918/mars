...
///echo '<a class="btnl mt4" href="../corpBlackList/506"><img src="/images/ignored.png" width="24" height="24" alt="" title=""> Черный список</a>';
...
?>
<div id="pokazat"> 
<a class="btnl mt4" href="#" onClick="document.getElementById('pokazat').style.display='none';document.getElementById('skryt').style.display='';return false;"><img width="24" height="24" src="/images/arrow_up2.png"> Статус корпорации <img width="24" height="24" src="/images/arrow_up2.png"></a>
...
<input style="width: 95%;" type="text" name="status_text" value="'.$corp['status_text'].'"/> <br>
...
mysql_query("UPDATE `corp` SET `status_text` = '".$status_text."' WHERE `id` = '".$corp['id']."'");
header('Location: ?');
...
<a class="btnl mt4" href="#" onClick="document.getElementById('skryt').style.display='none';document.getElementById('pokazat').style.display='';return false;"><img width="24" height="24" src="/images/arrow_down2.png"> Статус корпорации <img width="24" height="24" src="/images/arrow_down2.png"></a>
</div>
<?
}
...
if(isset($_GET['open/'])){
if ($corp['open'] == 0){
mysql_query("UPDATE `corp` SET `open` = '".($corp['open'] = 1)."' WHERE `id` = '".$corp['id']."' LIMIT 1");
}else{
mysql_query("UPDATE `corp` SET `open` = '".($corp['open'] = 0)."' WHERE `id` = '".$corp['id']."' LIMIT 1");
}
header('Location: ?');}

if ($corp['open'] == 1){$knopk1 = 'открытая';}else{$knopk1 = '<u><a href="?open/"> открытая</a></u>';}
if ($corp['open'] == 0){$knopk2 = 'закрытая';}else{$knopk2 = '<u><a href="?open/"> закрытая</a></u>';}
echo '<div class="bordered" style="margin-top: 4px; position: relative;"><font color=black size=2>Корпорация:</font> '.$knopk1.' / '.$knopk2.' </div>';
}
